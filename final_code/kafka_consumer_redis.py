...
#         'default.topic.config': {'auto.offset.reset': 'smallest'}
        ...
        self.redisCacheService = redisService.RedisService()
    ...
    def msg_process(self, msg):
        # self.redisCacheService.cahce_latest_tweet(json.loads(msg.value()))
...
kafka_consumer = KafkaConsumerRedis()
