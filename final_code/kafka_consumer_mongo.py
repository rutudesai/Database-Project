...
class KafkaConsumerMongo:

    def __init__(self):
        self.conf = {'bootstrap.servers': apc.KAFKA_BROKERS,
        'group.id': apc.KAFKA_MONGO_CONSUMER,
...
#         'default.topic.config': {'auto.offset.reset': 'smallest'}
        ...
        self.mongoDBService = mongoservice.MongoDBService()
    ...
    def msg_process(self, msg):
        self.mongoDBService.process_tweet(json.loads(msg.value()))
...
kafka_consumer = KafkaConsumerMongo()
